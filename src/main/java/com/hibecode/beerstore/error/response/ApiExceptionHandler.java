package com.hibecode.beerstore.error.response;

import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.hibecode.beerstore.error.response.ErrorResponse.ApiError;
import com.hibecode.beerstore.service.exception.BusinessException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidFormatException(BusinessException exception
            , Locale locale) {
